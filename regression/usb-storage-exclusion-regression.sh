...
usb_sysfs_device_is_ethernet() { return 1; }
...
run_case() {
  local case_name="$1" conf="$2" input_file="$3" out_file="$4" stdout_file="$5" stderr_file="$6"
...
assert_eq "case1 prompt_yn called once" "1" "$prompt_yn_calls"
...
assert_eq "case2 prompt_yn called once" "1" "$prompt_yn_calls"
...
assert_eq "case3 prompt_yn called once" "1" "$prompt_yn_calls"
